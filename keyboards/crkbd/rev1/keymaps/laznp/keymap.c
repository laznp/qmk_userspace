...
const uint16_t PROGMEM switch_layer2[] = {KC_J,    KC_K,   KC_L, COMBO_END};

combo_t key_combos[] = {
    COMBO(switch_layer0, TO(0)),
    COMBO(switch_layer2, TO(2)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LCTL,   KC_LGUI,  KC_ENT,     KC_SPC,   MO(1), MO(3)
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_ENT,    MO(3),  KC_SPC,  _______, _______, _______
                                      //`--------------------------'  `--------------------------'
  ),
